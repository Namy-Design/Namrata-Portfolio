...
export default function App() {
  ...
  useGSAP(() => {
    ...
    const handleScrollEffects = (scrollPosition: number) => {
      ...
      if (sliderDiv) sliderDiv.style.zIndex = scrollPosition >= windowHeight ? '0' : '1';
  ...
  return (
    <>
      ...
      <div className="left-sticky-menu">
          ...
          <div className="page-container" style={{ padding: '0px', width: '100%' }}>
            ...
            <div id="page-4-selector-container">
              <div className="what-i-do-selector">
                <div className="what-i-do-text">BLUEPRINT</div>
                <div className="hover-highlight"> Now AI does the digging, competitors, patterns, user data.<br />I do the thinking. Surprisingly, prompts can't replace that yet</div>
                <div className="hover-aboslute-bg"></div>
              </div>
              <div className="what-i-do-selector">
                <div className="what-i-do-text">VISUAL</div>
                <div className="hover-highlight"> Moodboards consumed, references digested, trends ignored.<br />What comes out is mine, not a Dribbble copy with a new color palette</div>
                <div className="hover-aboslute-bg"></div>
              </div>
              <div className="what-i-do-selector">
              ...
              <div className="what-i-do-selector">
                ...
                <div className="hover-highlight"> Shipped isn't done. User interviews, A/B tests, dev & PM follow-ups.<br />I stick around until the numbers have something to say</div>
                <div className="hover-aboslute-bg"></div>
              </div>
            </div>
          </div>
       ...
       <div className="page" id="page-7">
          <div className="page-7-container" id="page-7-container-1">
            ...
            <div className="page-7-content-container" id="e-invoice-content">
              <div className="app-image-container">
                <a href="./mybillbook.html" className="app-image-link" target="_blank" rel="noreferrer">
                  <picture>
          ...
          <div className="page-7-container" id="page-7-container-2" style={{ alignItems: 'center' }}>
            <div className="page-7-content-container" id="digi-gold-content">
              <div className="app-image-container">
                <a href="./goldsetu.html" className="app-image-link" target="_blank" rel="noreferrer">
                  <picture>
                    {/* Image for Mobile/Tablet */}
          ...
          <div className="page-7-container" id="page-7-container-3" style={{ alignItems: 'center' }}>
            <div className="page-7-content-container" id="groc-content">
              <div className="app-image-container">
                <a href="./group_orders.html" className="app-image-link" target="_blank" rel="noreferrer">
                  <picture>
                    {/* Image for Mobile/Tablet */}
